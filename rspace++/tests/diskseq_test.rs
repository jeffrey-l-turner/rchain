...
mod tests {
    ...
    fn diskseq_test_produce_match() {
        ...
        let cres = diskseq.consume(receive, false);
        ...
        let pres = diskseq.produce(send, false);
    ...
    fn diskseq_test_multiple_channels_consume_match() {
        ...
        let pres1 = diskseq.produce(send1, false);
        ...
        let pres2 = diskseq.produce(send2, false);
    ...
    fn diskseq_test_consume_persist() {
        ...
        let cres = diskseq.consume(receive, true);
    ...
    fn diskseq_test_consume_persist_existing_matches() {
        ...
        let _pres1 = diskseq.produce(send1, false);
        ...
        let _pres2 = diskseq.produce(send2, false);
        ...
        let cres1 = diskseq.consume(receive1, true);
        ...
        let cres2 = diskseq.consume(receive2, true);
        ...
        let cres3 = diskseq.consume(receive3, true);
        ...
        let pres3 = diskseq.produce(send3, false);
    ...
    fn diskseq_test_produce_persist() {
        ...
        let pres = diskseq.produce(send, true);
    ...
    fn diskseq_test_produce_persist_existing_matches() {
        ...
        let cres1 = diskseq.consume(receive1, false);
        ...
        let pres1 = diskseq.produce(send1, true);
        ...
        let pres2 = diskseq.produce(send2, true);
        ...
        let _cres2 = diskseq.consume(receive2, false);
